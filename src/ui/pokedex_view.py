...
class PokedexView(View):
    ...
    def generate_embeds(self) -> dict[str, discord.Embed]:
        embeds = {}
    ...
    async def on_timeout(self) -> None:
        ...
        self.embeds[self.current_embed].color = discord.Color.dark_grey()
        self.embeds[self.current_embed].set_footer(text="This interaction has timed out.")
